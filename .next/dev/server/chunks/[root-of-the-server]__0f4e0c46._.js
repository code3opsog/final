...
"[project]/src/app/api/accounts/[id]/auto-filter/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const { data: account, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').select('auto_filter_enabled, auto_filter_interval, last_auto_fetch').eq('id', id).eq('user_id', user.id).single();
        if (error || !account) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            enabled: account.auto_filter_enabled,
            interval: account.auto_filter_interval,
            lastFetch: account.last_auto_fetch
        });
    } catch (error) {
        console.error('Error getting auto-filter status:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request, context) {
    try {
        ...
        const { data: account } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').select('id').eq('id', id).eq('user_id', user.id).single();
        if (!account) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Account not found'
            }, {
        ...
        if (body.enabled !== undefined) {
            updates.auto_filter_enabled = body.enabled;
        }
        if (body.interval !== undefined) {
            // Validate interval (min 1 min, max 60 min)
            const interval = Math.min(60, Math.max(1, parseInt(body.interval) || 5));
            updates.auto_filter_interval = interval;
        }
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').update(updates).eq('id', id);
        if (error) {
            console.error('Error updating auto-filter:', error);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f4e0c46._.js.map