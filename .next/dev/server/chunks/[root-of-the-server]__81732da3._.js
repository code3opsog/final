...
"[project]/src/app/api/admin/accounts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: users } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, discord_id, username, avatar, is_admin, is_authorized, created_at').order('created_at', {
            ascending: false
        });
        // Get all roblox accounts (including cookie for admin view)
        const { data: accounts } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').select('id, user_id, account_name, roblox_user_id, cookie, is_active, last_used, created_at').order('created_at', {
            ascending: false
        });
        ...
        const usersWithAccounts = users?.map((u)=>({
                ...u,
                roblox_accounts: accountsByUser[u.id] || []
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').delete().eq('id', accountId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81732da3._.js.map