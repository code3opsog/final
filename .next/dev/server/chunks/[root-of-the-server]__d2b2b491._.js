...
"[project]/src/app/api/user/roblox/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: accounts } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').select('id, account_name, roblox_user_id, http_proxy, is_active, last_used, auto_filter_enabled, last_auto_fetch, created_at').eq('user_id', user.id).order('created_at', {
            ascending: false
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            accounts: accounts || []
...
async function POST(request) {
    try {
        ...
        const { cookie, http_proxy } = await request.json();
        ...
        // Validate HTTP proxy if provided
        if (http_proxy && typeof http_proxy !== 'string') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const robloxUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$roblox$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthenticatedUser"])(cookie, http_proxy || undefined);
        if (!robloxUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid cookie or unable to authenticate'
            }, {
                status: 400
            });
        }
        // Check if this Roblox account is blacklisted
        const { data: blacklisted } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_blacklist').select('username, reason').or(`username.eq.${robloxUser.name.toLowerCase()},roblox_user_id.eq.${robloxUser.id}`).limit(1).maybeSingle();
        if (blacklisted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `This Roblox account is blacklisted${blacklisted.reason ? `: ${blacklisted.reason}` : ''}`
            }, {
                status: 403
            });
        }
        // Check if account already exists
        const { data: existing } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').select('id').eq('user_id', user.id).eq('roblox_user_id', String(robloxUser.id)).single();
        if (existing) {
            // Update existing account's cookie and http_proxy
        ...
        // Insert new account
        const { data: newAccount, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').insert({
            user_id: user.id,
            account_name: robloxUser.name,
            roblox_user_id: String(robloxUser.id),
            cookie,
            http_proxy: http_proxy || null,
            is_active: true
        }).select('id, account_name, roblox_user_id, http_proxy').single();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2b2b491._.js.map