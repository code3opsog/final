...
"[project]/src/app/api/filter/remove-all-friends/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const stream = new ReadableStream({
        async start (controller) {
            ...
            try {
                ...
                let cookie = null;
                if (accountId) {
                    const { data: account } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('roblox_accounts').select('cookie').eq('id', accountId).eq('user_id', user.id).single();
                    if (!account) {
                        sendEvent({
                            type: 'error',
                ...
                const authUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$roblox$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthenticatedUser"])(cookie, await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$global$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlobalProxy"])());
                ...
                sendEvent({
                    type: 'progress',
                    phase: 'Fetching friends list...',
                    percent: 5,
                    removed: 0,
                    total: 0
                });
                // Fetch all friends
                const friends = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$roblox$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFriends"])(cookie, await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$global$2d$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlobalProxy"])());
                if (friends.length === 0) {
                    sendEvent({
                        type: 'complete',
                        removed: 0,
                ...
                for(let i = 0; i < friends.length; i++){
                    ...
                    try {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$roblox$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unfriendUser"])(friend.id, cookie, csrfToken, proxy);
                        if (result.success) {
                            removed++;
                            logs.push({
                                action: 'unfriended',
                ...
                if (logs.length > 0) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('filter_logs').insert(logs.map((log)=>({
                            user_id: user.id,
                            action: log.action,
                ...
                sendEvent({
                    type: 'error',
                    message: 'Remove all friends failed'
                });
                controller.close();
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a3edcdd._.js.map