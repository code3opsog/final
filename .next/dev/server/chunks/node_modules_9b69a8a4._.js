...
const version = '2.95.0'; //# sourceMappingURL=version.js.map
}),
...
"[project]/node_modules/roblox-bat/esm/src/utils/constants.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const DEFAULT_FORCE_BAT_URLS = [
    "/account-switcher/v1/switch"
];
const BAT_SIGNATURE_VERSION = "v1";
...
"[project]/node_modules/roblox-bat/esm/_dnt.shims.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/roblox-bat/esm/src/utils/crypto.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/roblox-bat/esm/src/utils/constants.js [app-route] (ecmascript)");
;
async function hashStringSha256(str) {
    const uint8 = new TextEncoder().encode(str);
    const hashBuffer = await crypto.subtle.digest(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TOKEN_SIGNATURE_ALGORITHM"].hash.name, uint8);
...
async function signWithKey(privateKey, data) {
    const bufferResult = await crypto.subtle.sign(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TOKEN_SIGNATURE_ALGORITHM"], privateKey, new TextEncoder().encode(data));
...
"[project]/node_modules/roblox-bat/esm/src/utils/filterObject.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/roblox-bat/esm/src/hbaClient.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$_dnt$2e$shims$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/roblox-bat/esm/_dnt.shims.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/roblox-bat/esm/src/utils/constants.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$crypto$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/roblox-bat/esm/src/utils/crypto.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$filterObject$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/roblox-bat/esm/src/utils/filterObject.js [app-route] (ecmascript)");
;
;
;
;
class HBAClient {
     ...
     */ fetch(url, params) {
        const headers = new Headers((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$filterObject$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["filterObject"])(this.headers));
        if (params?.headers) {
   ...
   */ async generateBaseHeadersFromUnsignedBAT(requestUrl, includeCredentials, data) {
        ...
        return {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TOKEN_HEADER_NAME"]]: token
        };
    }
    /**
     ...
     */ async getTokenMetadata(uncached) {
        ...
        const promise = (async ()=>{
            ...
            let isAuthenticated;
            let doc;
            const canUseDoc = "DOMParser" in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$_dnt$2e$shims$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dntGlobalThis"] && "document" in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$_dnt$2e$shims$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dntGlobalThis"];
            if (uncached || !canUseDoc || !document.querySelector?.(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FETCH_TOKEN_METADATA_SELECTOR"]) || !document.querySelector?.(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FETCH_USER_DATA_SELECTOR"]) && document?.readyState === "loading") {
                const text = await this.fetch(this.urls.fetchTokenMetadataUrl).then((res)=>res.text()).catch(()=>{});
                if (!text) return null;
                if (!canUseDoc) {
                    const match = text.match(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FETCH_TOKEN_METADATA_REGEX"]);
                    if (!match) {
                        return null;
                    }
                    try {
                        isAuthenticated = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FETCH_USER_DATA_REGEX"].test(text);
                        isSecureAuthenticationIntentEnabled = match[2] === "true";
                        isBoundAuthTokenEnabledForAllUrls = match[4] === "true";
                        try {
                            boundAuthTokenWhitelist = JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeEntities"])(match[6]))?.Whitelist?.map((item)=>({
                                    ...item,
                        ...
                        try {
                            boundAuthTokenExemptlist = JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeEntities"])(match[8]))?.Exemptlist;
                        } catch  {
                        ...
                        hbaIndexedDbVersion = parseInt(match[16], 10) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_INDEXED_DB_VERSION"];
                    } catch  {
            ...
            if (doc) {
                const el = doc.querySelector?.(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FETCH_TOKEN_METADATA_SELECTOR"]);
                if (!el) {
                    return null;
                }
                try {
                    isAuthenticated = !!doc.querySelector?.(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FETCH_USER_DATA_SELECTOR"]);
                    ...
                    hbaIndexedDbVersion = parseInt(el.getAttribute("data-hba-indexed-db-version"), 10) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_INDEXED_DB_VERSION"];
                } catch  {
                    this.cachedTokenMetadata = undefined;
                    return null;
                }
     ...
     */ async getCryptoKeyPair(uncached) {
        ...
        if (!("indexedDB" in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$_dnt$2e$shims$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dntGlobalThis"])) {
            return null;
        }
        const promise = (async ()=>{
            ...
            try {
                const pair = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$crypto$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCryptoKeyPairFromDB"])(metadata.hbaIndexedDbName, metadata.hbaIndexedDbObjStoreName, metadata.hbaIndexedDbKeyName);
     ...
     */ async signBATData([hashedBody, timestamp, payload1, payload2]) {
        ...
        const signatures = await Promise.all([
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$crypto$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signWithKey"])(pair.privateKey, payload1),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$crypto$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signWithKey"])(pair.privateKey, payload2)
        ]);
        return [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BAT_SIGNATURE_VERSION"],
            hashedBody,
            timestamp,
            signatures[0],
            signatures[1]
        ].join(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AUTH_TOKEN_SEPARATOR"]);
    }
    /**
     ...
     */ async generateUnsignedBAT(requestUrl, requestMethod = "GET", body) {
        ...
        const hashedBody = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$crypto$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashStringSha256"])(strBody);
        const payload1 = [
            hashedBody,
            timestamp,
            requestUrl.toString(),
    ...
    constructor({ fetch: fetch1, headers, onSite, keys, urls, cookie } = {}){
        ...
        Object.defineProperty(this, "urls", {
            ...
            writable: true,
            value: {
                fetchTokenMetadataUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_FETCH_TOKEN_METADATA_URL"],
                matchRobloxBaseUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_MATCH_ROBLOX_URL_BASE"],
                forceBATUrls: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$roblox$2d$bat$2f$esm$2f$src$2f$utils$2f$constants$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_FORCE_BAT_URLS"]
            }
        });
        if (fetch1) {
...
"[project]/node_modules/roblox-bat/esm/mod.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_9b69a8a4._.js.map