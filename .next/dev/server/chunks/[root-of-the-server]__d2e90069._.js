...
async function GET() {
    try {
        ...
        const { data: users } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, discord_id, username, email, avatar, is_authorized, auth_expiry, is_admin, created_at').order('created_at', {
            ascending: false
        });
...
async function POST(request) {
    try {
        ...
        const authExpiry = days > 0 ? new Date(Date.now() + days * 24 * 60 * 60 * 1000).toISOString() : null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2e90069._.js.map