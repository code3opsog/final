...
async function POST(request) {
    try {
        ...
        if (Object.keys(updates).length > 0) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').update(updates).eq('id', user.id);
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2359818f._.js.map