...
"[project]/src/app/api/auth/discord/callback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAppUrl(requestUrl) {
    return ("TURBOPACK compile-time value", "http://localhost:3000") || requestUrl;
}
async function GET(request) {
    ...
    if (!code) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/?error=no_code', baseUrl));
    }
    try {
        // Exchange code for token
        const tokenData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["exchangeCodeForToken"])(code);
        ...
        if (tokenData.error) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`/?error=token_exchange&desc=${encodeURIComponent(tokenData.error_description || tokenData.error)}`, baseUrl));
        }
        // Get Discord user info
        const discordUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDiscordUser"])(tokenData.access_token);
        if (!discordUser.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/?error=user_fetch', baseUrl));
        }
        // Check if user is the admin
        const isAdmin = discordUser.id === process.env.ADMIN_DISCORD_ID;
        // Check if user exists
        const { data: existingUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('discord_id', discordUser.id).single();
        let user;
        if (existingUser) {
            // Update existing user
            const { data: updatedUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').update({
                username: discordUser.username,
                email: discordUser.email,
                avatar: discordUser.avatar,
                is_admin: isAdmin || existingUser.is_admin,
                updated_at: new Date().toISOString()
            }).eq('discord_id', discordUser.id).select().single();
            user = updatedUser;
        } else {
            // Create new user
            const { data: newUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('users').insert({
        ...
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/?error=user_create', baseUrl));
        }
        ...
        // Create session
        const sessionToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])(user.id, user.discord_id, user.is_admin, ip, userAgent);
        // Set cookie and redirect
        const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/dashboard', baseUrl));
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/?error=callback_error', baseUrl));
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__7c8c8491._.js.map